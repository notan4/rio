...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!args[0]) return message.channel.send("**Người dùng nào bạn muốn trở thành cơ?**");
        if (!args[1]) return message.channel.send("**Người dùng nào bạn muốn đặt trên cơ?**");
        ...
        if (!base) return message.channel.send("**Không tìm thấy người dùng cơ!**");
        ...
        if (!overlay) return message.channel.send("**Không tìm thấy người dùng phủ!**");
        ...
        try {
            ...
            return message.channel.send(`Ồ không, đã xảy ra lỗi: \`${err.message}\`. Thử lại sau!`);
        };
    }
};